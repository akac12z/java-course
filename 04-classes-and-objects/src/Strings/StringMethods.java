...
public class StringMethods {
    public static void main(String[] args) {
        ...
        System.out.println("Longitud: " + text.length()); // 12. incluye espacios y caracteres especiales

        // Método charAt(int index)
        System.out.println("Carácter en la posición 2: " + text.charAt(2)); // 'l' devuelve la L porque se empieza a contar desde el 0
